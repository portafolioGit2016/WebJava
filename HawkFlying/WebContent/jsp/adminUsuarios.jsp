...
<body>
	...
	<div id="modal2" class="modal">
		<form:form class="col s12" method="post" action="adminUsuarios"
			modelAttribute="registroBean">
			<div class="modal-content">
				...
				<div class="row">
					...
					<form:input type="date" id="fecNacCreate" path="fecha_Nacimiento"
						placeholder="Fecha de nacimiento" />
			...
			<div class="modal-footer">
				<button type="submit"
					class=" modal-action modal-close waves-effect waves-green btn-flat">Crear</button>
			</div>
		</form:form>
	</div>
