...
@JsonPropertyOrder({ "id_aeronave", "tipo", "cantidad_horas", "fecha_inspeccion", "ano_fabricacion", "fecha_dgac",
		"tipo_modelo", "capacidad", "hr_autonomia", "marca", "estado", "fecha_de_vencimiento", "matricula" })
